...
cask 'font-lohit-devanagari'
cask 'font-lohit-gujarati'
cask 'font-lohit-kannada'
cask 'font-lohit-malayalam'
cask 'font-lohit-marathi'
cask 'font-lohit-nepali'
cask 'font-lohit-oriya'
cask 'font-lohit-punjabi'
cask 'font-lohit-tamil-classical'
cask 'font-lohit-tamil'
cask 'font-lohit-telugu'
...
cask 'font-open-sans-hecask-condensed'
cask 'font-open-sans-hecask'
cask 'font-open-sans'
